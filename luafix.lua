...
UpdateAccountInfo()
 ...
 local success, Features = pcall(function()
      return loadstring(game:HttpGet("https://raw.githubusercontent.com/meng-hub-fshit/MengHub-FishIt/refs/heads/main/Features.lua"))()
  end)
  if not success or not Features then
      warn("Failed to load features: " .. tostring(Features))
      Features = nil  -- Set ke nil biar tidak error
  end
